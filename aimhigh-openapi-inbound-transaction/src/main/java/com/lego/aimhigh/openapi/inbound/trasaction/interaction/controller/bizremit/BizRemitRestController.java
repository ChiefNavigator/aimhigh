package com.lego.aimhigh.openapi.inbound.trasaction.interaction.controller.bizremit;

import com.lego.aimhigh.openapi.inbound.trasaction.domain.usecase.bizremit.BizRemitUseCase;
...
import com.lego.aimhigh.openapi.inbound.trasaction.interaction.controller.bizremit.exception.BizRemitPayloadException;
import com.lego.aimhigh.openapi.inbound.trasaction.interaction.controller.bizremit.model.BizRemitRequestPayload;
...
public class BizRemitRestController {
  ...
  public ResultVo<Void> handleBizRemitException(BizRemitException ex) {
    log.error("handleBizRemitException", ex);
